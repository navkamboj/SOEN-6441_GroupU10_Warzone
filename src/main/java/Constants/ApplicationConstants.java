...
public class ApplicationConstants {
    ...
    public static final String INVALID_CMD_ERR_FOR_EDITCOUNTRY = "Invalid command. Please submit your command in Appropriate Format like : editcountry -add countrytID continentID -remove countryID";
    public static final String INVALID_CMD_ERR_FOR_EDITNEIGHBOUR = "Invalid command. Please submit your command in Appropriate Format like : editneighbor -add countryID neighborcountryID -remove countryID neighborcountryID";
